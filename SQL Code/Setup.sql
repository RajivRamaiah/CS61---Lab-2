...
-- -----------------------------------------------------
-- Table `rajiv_db`.`CREDENTIALS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rajiv_db`.`CREDENTIALS` (
...
INSERT INTO CREDENTIALS (USER_TYPE,ID, PASSWORD) VALUES 
  ("EDITOR", 1, AES_ENCRYPT('a','AA12345678')),
  ("EDITOR", 2, AES_ENCRYPT('a','AA12345678')),
  ("EDITOR", 3, AES_ENCRYPT('a','AA12345678')),
  ("AUTHOR", 1, AES_ENCRYPT('a','AA12345678')),
  ("AUTHOR", 2, AES_ENCRYPT('a','AA12345678')),
  ("AUTHOR", 3, AES_ENCRYPT('a','AA12345678')),
  ("AUTHOR", 4, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 1, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 2, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 3, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 4, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 5, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 6, AES_ENCRYPT('a','AA12345678')),
  ("REVIEWER", 7, AES_ENCRYPT('a','AA12345678'));
